...
const SignUp = () => {
  ...
  return (
    <section>
        <h1 className='text-3xl text-center mt-6 font-bold md:mb-6 mb-12'>Sign Up</h1>
            ...
            <div  className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
                ...
                <input type='text' 
                    ...
                    <div className='flex justify-between whitespace-nowrap text-sm sm:text-md mb-4'>
                        <p className='md-6'>Having an account? <Link to='/sign-in'
                ...
                <button 
                className='w-full bg-blue-600 text-white px-7 py-2 text-xs font-mde
